# Linearize
Construct a linear, no-fork, best version of the Aif blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install aif_hash

https://github.com/raipat/aifcoin_hash
...
JSON-RPC server. Running `aifd` or `aif-qt -server` will be sufficient.
...
* `input`: aifd blocks/ directory containing blkNNNNN.dat
