...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Aif related functionality
...
/*
    ...
    allow endless transaction that would bloat Aif and make it unusable. To
