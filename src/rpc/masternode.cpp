...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Aif address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "aif",               "masternode",             &masternode,             true,  {} },
    { "aif",               "masternodelist",         &masternodelist,         true,  {} },
    { "aif",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "aif",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "aif",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "aif",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
