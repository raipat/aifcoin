...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in aif.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("aif.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Aif features */
    { "aif",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "aif",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "aif",               "gobject",                &gobject,                true,  {} },
    { "aif",               "voteraw",                &voteraw,                true,  {} },
