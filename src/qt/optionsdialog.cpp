    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("AIF-light"), QVariant("light"));
    ui->theme->addItem(QString("AIF-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("AIF-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("AIF-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("AIF-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("AIF-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("AIF-traditional"), QVariant("trad"));
