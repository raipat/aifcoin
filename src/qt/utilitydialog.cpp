    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  aif-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Aif in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 AIF, 0.1 AIF, 1 AIF and 10 AIF -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://aifdev.atlassian.net/wiki/display/DOC/PrivateSend\">https://aifdev.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
