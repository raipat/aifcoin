...
This mechanism has been integrated into Bitcore-Node-Aif which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/aifdev/insight-api-aif#web-socket-api](https://github.com/aifdev/insight-api-aif#web-socket-api)
* API: [https://github.com/aifdev/insight-api-aif#instantsend-transactions](https://github.com/aifdev/insight-api-aif#instantsend-transactions)
...
By default, the Aif Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Aif Core daemon:
